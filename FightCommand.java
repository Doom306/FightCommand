                                        ...
                                        if (win(healthVictim, healthChallenger, challenger, true)) {
                                            ...
                                            if (win(healthChallenger, healthVictim, victim, false)) {
                                                if (healthVictim > healthChallenger) {
                                                    final Double challengerMoney = MoneyData.money.get(userChallenger);
                                                    final Double victimMoney = MoneyData.money.get(userVictim);
                                                    MoneyData.money.put(userVictim, victimMoney + 1000);
                                                    MoneyData.money.put(userChallenger, challengerMoney - 1000);
